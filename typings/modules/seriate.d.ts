// Type definitions for ./node_modules/seriate/src/index.js
 ...
 * @param queryOptions
 */
declare function promisify(context: any, queryOptions: any): void;

/**
 *
 */
declare module "seriate" {
	 ...
	 * @param connection
	 */
	function getTransactionContext(connection: Connection): void;

	/**
	 *
	 * @param connection
	 */
	function getPlainContext(connection: Connection): void;
	 ...
	 * @param queryOptions
	 */
	function executeTransaction(connection: any, queryOptions: any): void;
	 ...
	 * @param queryOptions
	 */
	function execute(connection?: any, queryOptions?: any): Promise<recordSet>;
	 ...
	 * @param config
	 */
	function addConnection(config: any): void;
	 ...
	 * @param config
	 */
	function closeConnection(config: any): void;
	 ...
	 * @param namespace
	 */
	function useMetrics(metrics: any, namespace: any): void;
}
